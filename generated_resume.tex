\renewcommand{\JobDescriptionGraduateResearchAssistantOne}{Improved ERP platform’s data handling with ML models, enhancing accuracy by over 78\%.}
\renewcommand{\JobDescriptionGraduateResearchAssistantTwo}{Formulated sentiment analysis models, boosting enrollment by 25\%.}
\renewcommand{\JobDescriptionDataAnalystOne}{Improved ERP platform’s data handling with ML models, enhancing accuracy by over 78\%.}
